...
2. Edit the **global system prompt** (`global.system`). This prompt is merged into the AI context for chat across all workspaces and documents. Workspace and document prompts supplement or override it.
3. Save.
